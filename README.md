# crtycon - Automatic SMS Networking Card Distributor

This is a completely fresh, professional implementation of the crtycon system.
...
1. Run the following command in the terminal:
   ```bash
   git add .
   git commit -m "Initialize fresh crtycon project"
...
- **Queue Management**: Background service (KrootService) handles the logic without freezing the UI.
